...
export default function App() {
  ...
  const remainFine = (memberId) => {
    const total = allMemberFines[memberId] || 0;
                  ...
                  <div key={m.id} style={{
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                      ...
                      <div style={{ textAlign: "right" }}>
                        <div style={{ fontSize: "11px", color: C.sub }}>미납 {allMemberFines[m.id].toLocaleString()}원</div>
                        <div style={{ fontSize: "13px", fontWeight: "800", color: remain === 0 ? C.green : C.red }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      ...
                      <input
                        type="number"
                        value={paid || ""}
                        onChange={e => updatePaidAmount(m.id, e.target.value)}
                        placeholder="0"
                        style={{
              ...
              return (
                <div key={m.id} style={{
                  ...
                  <div style={{
                    ...
                    color: remainFine(m.id) === 0 ? C.green : C.red,
                  }}>
